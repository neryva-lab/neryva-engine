...
> **2026-08-23 (implementation note):** S-1…S-4 implemented (`products_manifests/agent_studio.yaml` + `src/modules/agent-studio`, eng-0006) — marked `[~]` until gates run. S-5 stays `[ ]` (closes with runtime A-3).
