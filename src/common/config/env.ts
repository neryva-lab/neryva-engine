...
const envSchema = z.object({
  ...
  WORKERS__WEBHOOK_SWEEP_ENABLED: boolean(true),
  WORKERS__WEBHOOK_SWEEP_INTERVAL_MS: positiveInt(60_000, 3_600_000),
  WORKERS__WEBHOOK_SWEEP_BATCH: positiveInt(10, 500),
